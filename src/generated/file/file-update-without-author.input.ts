...
import { NoteUpdateOneWithoutFileNestedInput } from '../note/note-update-one-without-file-nested.input';

@InputType()
export class FileUpdateWithoutAuthorInput {
    ...
    @Field(() => NoteUpdateOneWithoutFileNestedInput, {nullable:true})
    Note?: NoteUpdateOneWithoutFileNestedInput;
}
